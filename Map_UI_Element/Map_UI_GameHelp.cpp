...
Map_UI_GameHelp::Map_UI_GameHelp(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_GameHelpButton = new Button(m_Game, 590, 430, 0, 190, 36, 19, false, Ptr_GameHelp_Game->resource->CreateTexture(2, 25, false).Texture);
}
...
void Map_UI_GameHelp::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_GameHelp):
	{
		Ptr_GameHelp_Game->Draw(Ptr_GameHelp_MapUI->Sprite, Ptr_GameHelp_Game->resource->CreateTexture(2, 63, false).Texture, 102, 332, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
		break;
	}
	default:
		return;
