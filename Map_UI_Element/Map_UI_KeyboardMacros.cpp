...
Map_UI_KeyboardMacros::Map_UI_KeyboardMacros(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_KeyboardMacrosButton = new Button(m_Game, 590, 390, 0, 152, 36, 19, false, Ptr_Macro_Game->resource->CreateTexture(2, 25, false).Texture);
}
...
void Map_UI_KeyboardMacros::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_KeyboardMacros):
	{
		//Ptr_Macro_Game->Draw(Ptr_Macro_MapUI->Sprite, Ptr_Macro_Game->resource->CreateTexture(2, 63, false).Texture, 102, 332, 0, D3DCOLOR_ARGB(255, 255, 255, 255));
		break;
	}
	default:
		return;
