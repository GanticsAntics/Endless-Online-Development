...
Map_UI_GameSettings::Map_UI_GameSettings(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_GameSettingsButton = new Button(m_Game, 590, 410, 0, 171, 36, 19, false, Ptr_Settings_Game->resource->CreateTexture(2, 25, false).Texture);
}
...
void Map_UI_GameSettings::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_GameSettings):
	{
		Ptr_Settings_Game->Draw(Ptr_Settings_MapUI->Sprite, Ptr_Settings_Game->resource->CreateTexture(2, 47, false).Texture, 102, 332, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
		break;
	}
	default:
		return;
