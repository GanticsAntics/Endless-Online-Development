...
UI_ChatBubbleHandler::UI_ChatBubbleHandler(void* m_UIElement, void* m_Game)
{
...
void UI_ChatBubbleHandler::Update()
{
	int counter = 0;
...
void UI_ChatBubbleHandler::RenderChatBubble(BubbleContainer _Message, int Index)
{
	if (!_Message._IsNPC)
	{
...
void UI_ChatBubbleHandler::Render()
{
	int counter = 0;
	for each (BubbleContainer container in this->ChatBubbleList)
	{
...
void UI_ChatBubbleHandler::AddMapMessage(std::string Message, int PlayerID, bool IsNPC , D3DCOLOR BG_color, D3DCOLOR TextCol_color)
{
	int counter = 0;
	for each (BubbleContainer container in this->ChatBubbleList)
	{
...
UI_ChatBubbleHandler::~UI_ChatBubbleHandler()
{
