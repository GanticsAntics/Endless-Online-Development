...
Map_UI_Map::Map_UI_Map(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_MapButton = new Button(m_Game, 62, 350, 0, 19, 36, 19, false, Ptr_MapUI_Game->resource->CreateTexture(2, 25, false).Texture);
}
...
void Map_UI_Map::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_Map):
	{
		//Ptr_MapUI_Game->Draw(Ptr_MapUI_MapUI->Sprite, Ptr_MapUI_Game->resource->CreateTexture(2, 63, false).Texture, 102, 332, 0, D3DCOLOR_ARGB(255, 255, 255, 255));
		break;
	}
	default:
		return;
