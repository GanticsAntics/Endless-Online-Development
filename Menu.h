...
public:
	...
	Resource::TextureData LoginBoxTex;
	Resource::TextureData BgTex;
	Resource::TextureData FgTex;
	Resource::TextureData CharacterBox;
	Resource::TextureData LoginFgTex;
	Resource::TextureData CreateCharTex;
	Resource::TextureData ChangePassTex;
