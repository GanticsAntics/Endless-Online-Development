...
void Map_UI::Initialize(World* _world, IDirect3DDevice9Ptr m_Device, LPVOID* m_game)
{
	...
	HudStatsTexture = UI_Game->ResourceManager->CreateTexture(2, 58, true).Texture;
}
...
void Map_UI::Render()
{
	...
	UI_Game->Draw(this->Sprite, UI_Game->ResourceManager->CreateTexture(2, 1, true).Texture, 1, 1, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));

	UI_Game->Draw(this->Sprite, UI_Game->ResourceManager->CreateTexture(2, 21, true).Texture, 1, 1, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
	UI_Game->Draw(this->Sprite, UI_Game->ResourceManager->CreateTexture(2, 20, true).Texture, 18, 310, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
