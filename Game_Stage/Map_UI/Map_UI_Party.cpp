...
Map_UI_Party::Map_UI_Party(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_PartyButton = new Button(m_Game, 590, 370, 0, 133, 36, 19, false, Ptr_Party_Game->ResourceManager->CreateTexture(2, 25, false).Texture);
}
...
void Map_UI_Party::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_Party):
	{
		Ptr_Party_Game->Draw(Ptr_Party_MapUI->Sprite, Ptr_Party_Game->ResourceManager->CreateTexture(2, 42, false).Texture, 102, 332, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
		break;
	}
	default:
		return;
