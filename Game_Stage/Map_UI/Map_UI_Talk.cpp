...
Map_UI_Talk::Map_UI_Talk(void* m_UIElement, void* m_Game)
{
	...
	this->UI_Element_TalkButton = new Button(m_Game, 62, 410, 0, 76, 36, 19, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 25, false).Texture);
	this->UI_Element_LockText = new  Button(m_Game, 395 + (43 * 4), 433, 440, 16, 19, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	...
	UI_WhisperChatButtons[0] = new Button(m_Game, 123, 433, 0, 16, 132, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	UI_WhisperChatButtons[0]->SetHighlightOnMouseDown(true);
	UI_WhisperChatButtons[1] = new Button(m_Game, 256, 433, 0, 16, 132, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	UI_WhisperChatButtons[1]->SetHighlightOnMouseDown(true);
	UI_ChatButtons[0] = new Button(m_Game, 389, 433, 264, 16, 43, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	UI_ChatButtons[0]->SetHighlightOnMouseDown(true);
	UI_ChatButtons[1] = new Button(m_Game, 390 + (43 * 1), 433, 264, 16, 43, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	UI_ChatButtons[1]->SetHighlightOnMouseDown(true);
	UI_ChatButtons[2] = new Button(m_Game, 391 + (43 * 2), 433, 264, 16, 43, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
	UI_ChatButtons[2]->SetHighlightOnMouseDown(true);
	UI_ChatButtons[3] = new Button(m_Game, 392 + (43 * 3), 433, 264, 16, 43, 16, false, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 35, false).Texture);
...
void Map_UI_Talk::Render()
{
	...
	case(Map_UI::UI_ElementStage::UI_Element_Talk):
	{
		Ptr_Talk_Game->Draw(Ptr_Talk_MapUI->Sprite, Ptr_Talk_Game->ResourceManager->CreateTexture(2, 28, false).Texture, 102, 332, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
